...
print('Step 7: Define the relationships between stromatolite phrases and '\
      'stratigraphic entities/mentions ...')
os.system('python ./udf/ext_strat_target.py')

#DEFINE RELATIONSHIPS BETWEEN TARGET AND DISTANT STRATIGRAPHIC NAMES
print('Step 8: Define the relationships between stromatolite phrases and '\
      'distant stratigraphic entities/mentions ...')
